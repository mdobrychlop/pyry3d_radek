...
import re, types, sys, cStringIO, md5, os.path, imp
...
tab_module  = os.path.join(os.path.dirname(__file__), 'parsetab.py')       # Default name of the table module
...
_lr_signature = %s
""" % (repr(_lr_method), repr(Signature.digest())))
...
def lr_read_tables(module=tab_module,optimize=0):
    ...
    try:
        global parsetab
        parsetab = imp.load_source('parsetab', module)
